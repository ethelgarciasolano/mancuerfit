...
!function(e, t) {
    ...
    !function(F) {
        ...
        F.valHooks.select.set = function(e, t) {
            return t && !n.useDefault && F(e).data("selected", !0),
        ...
        "4" === _.major && (q.DIVIDER = "dropdown-divider",
        q.SHOW = "show",
        ...
        function(e, t) {
            var i = this;
            n.useDefault || (F.valHooks.select.set = n._set,
            n.useDefault = !0),
            this.$element = F(e),
        ...
        "4" === _.major && (u.DEFAULTS.style = "btn-light",
        u.DEFAULTS.iconBase = "",
        ...
        u.prototype = {
            ...
            createDropdown: function() {
                var e, t = this.multiple || this.options.showTick ? " show-tick" : "", i = this.autofocus ? " autofocus" : "", s = "", n = "", o = "", l = "";
                return this.options.header && (s = '<div class="' + q.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                this.options.liveSearch && (n = '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + G(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search"></div>'),
                ...
                this.multiple && this.options.doneButton && (l = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + q.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
                e = '<div class="dropdown bootstrap-select' + t + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + i + ' role="button"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"></div></div> </div>' + ("4" === _.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") + '</button><div class="' + q.MENU + " " + ("4" === _.major ? "" : q.SHOW) + '" role="combobox">' + s + n + o + '<div class="inner ' + q.SHOW + '" role="listbox" aria-expanded="false" tabindex="-1"><ul class="' + q.MENU + " inner " + ("4" === _.major ? q.SHOW : "") + '"></ul></div>' + l + "</div></div>",
                F(e)
            },
            ...
            createView: function(C, e) {
                ...
                var z, T, D = [];
                function i(e, t) {
                    var i, s, n, o, l, r, a, c, d, h = O.selectpicker.current.elements.length, p = [], u = void 0, f = !0, m = O.isVirtual();
                    ...
                    (t || r) && (a = O.selectpicker.view.visibleElements ? O.selectpicker.view.visibleElements.slice() : [],
            ...
            createLi: function() {
                var z, T = this, D = [], H = 0, A = 0, L = [], N = 0, P = 0, R = -1;
                ...
                (T.options.showTick || T.multiple) && ((e = W.span.cloneNode(!1)).className = T.options.iconBase + " " + T.options.tickIcon + " check-mark",
                W.a.appendChild(e)),
                ...
                var M = function(e, t, i) {
                  ...
                  , V = function(e) {
                    ...
                    if (e.optionContent)
                        ...
                        e.optionSubtext && ((t = W.subtext.cloneNode(!1)).innerHTML = e.optionSubtext,
                        s.appendChild(t))
                    }
                ...
                j.each(function(e) {
                    ...
                    !t.hasClass("bs-title-option")) {
                        var i, s, n = t.data(), o = this.className || "", l = G(this.style.cssText), r = n.content, a = this.textContent, c = n.tokens, d = n.subtext, h = n.icon, p = t.parent(), u = p[0], f = "OPTGROUP" === u.tagName, m = f && u.disabled, v = this.disabled || m, g = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName, b = p.data();
                            ...
                            if (f && !0 !== n.divider) {
                                ...
                                if (!this.previousElementSibling) {
                                    ...
                                    var E = function(e) {
                                        ...
                                        return e.labelSubtext && ((t = W.subtext.cloneNode(!1)).textContent = e.labelSubtext,
                                        s.appendChild(t)),
                                        B.appendChild(s),
                                        B
                                    }({
            ...
            render: function() {
                ...
                for (var n = 0, o = this.selectpicker.main.elements.length; n < o; n++) {
                    ...
                    if (l && l.selected && (i.push(l),
                    s.length < 100 && "count" !== e.options.selectedTextFormat || 1 === i.length)) {
                        if (e.options.hideDisabled && (l.disabled || "OPTGROUP" === l.parentNode.tagName && l.parentNode.disabled))
                            return;
                        var r, a, c = this.selectpicker.main.data[n].data, d = c.icon && e.options.showIcon ? '<i class="' + e.options.iconBase + " " + c.icon + '"></i> ' : "";
            ...
            liHeight: function(e) {
                if (e || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var v, g = a.offsetHeight, b = l ? l.offsetHeight : 0, w = d ? d.offsetHeight : 0, I = h ? h.offsetHeight : 0, x = p ? p.offsetHeight : 0, k = u ? u.offsetHeight : 0, $ = F(o).outerHeight(!0), S = !!window.getComputedStyle && window.getComputedStyle(i), E = i.offsetWidth, y = S ? null : F(i), C = {
            ...
            getSelectPosition: function() {
                ...
                this.options.container && !s.is("body") ? ((e = s.offset()).top += parseInt(s.css("borderTopWidth")),
            ...
            setSize: function(e) {
                ...
                !1 !== this.options.size) {
                    ...
                    s.off("resize" + L + "." + this.selectId + ".setMenuSize scroll" + L + "." + this.selectId + ".setMenuSize")),
            ...
            selectPosition: function() {
                ...
                var s, n, o, l = this, r = F(this.options.container), e = function(e) {
                    ...
                    (_.major < 4 || "static" === i) && (t.top = s.top - n.top + o,
                ...
                this.$button.on("click.bs.dropdown.data-api", function() {
                    ...
                    l.$bsContainer.appendTo(l.options.container).toggleClass(q.SHOW, !l.$button.hasClass(q.SHOW)).append(l.$menu))
                }),
            ...
            setSelected: function(e, t, i, s) {
                var n, o, l, r = void 0 !== this.activeIndex, a = this.activeIndex === e || t && !this.multiple && !r;
                ...
                a && (this.selectpicker.view.currentActive = s,
                this.activeIndex = e),
                l && (l.classList.toggle("selected", t),
                l.classList.toggle("active", a),
                l.setAttribute("aria-selected", t)),
                a || !r && t && void 0 !== this.prevActiveIndex && (n = this.selectpicker.main.map.newIndex[this.prevActiveIndex],
                (o = this.selectpicker.main.elements[n]).classList.remove("active"),
            ...
            setDisabled: function(e, t, i, s) {
                ...
                n && ("4" === _.major && n.classList.toggle(q.DISABLED, t),
                n.setAttribute("aria-disabled", t),
                t ? n.setAttribute("tabindex", -1) : n.setAttribute("tabindex", 0))
            },
            isDisabled: function() {
            ...
            checkDisabled: function() {
                var e = this;
                this.isDisabled() ? (this.$newElement.addClass(q.DISABLED),
                this.$button.addClass(q.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0)) : (this.$button.hasClass(q.DISABLED) && (this.$newElement.removeClass(q.DISABLED),
            ...
            clickListener: function() {
                ...
                this.$newElement.on("show.bs.dropdown", function() {
                    3 < _.major && !S.dropdown && (S.dropdown = S.$button.data("bs.dropdown"),
                ...
                this.$menuInner.on("click", "li a", function(e, t) {
                    ...
                    !S.isDisabled() && !i.parent().hasClass(q.DISABLED)) {
                            ...
                            !1 !== u || !1 !== f) {
                                ...
                                if (u && m || f && v)
                                    if (u && 1 == u) {
                                        ...
                                        c.prop("selected", !1),
                                        S.$menu.append($),
                                        u && m && ($.append(F("<div>" + x + "</div>")),
                                        r = !1,
                                        S.$element.trigger("maxReached" + L)),
                                        f && v && ($.append(F("<div>" + k + "</div>")),
                                        r = !1,
                        ...
                        r && (o != E(S.$element[0]) && S.multiple || l != S.$element.prop("selectedIndex") && !S.multiple) && (y = [n, c.prop("selected"), o],
                ...
                this.$menu.on("click", "li." + q.DISABLED + " a, ." + q.POPOVERHEADER + ", ." + q.POPOVERHEADER + " :not(.close)", function(e) {
                    ...
                    e.stopPropagation(),
                    S.options.liveSearch && !F(e.target).hasClass("close") ? S.$searchbox.focus() : S.$button.focus())
                }),
            ...
            liveSearchListener: function() {
                ...
                this.$searchbox.on("input propertychange", function() {
                    ...
                    e) {
                        ...
                        f.innerHTML = u.options.noneResultsText.replace("{0}", '"' + G(e) + '"'),
            ...
            keydown: function(e) {
                var t, i, s, n, o, l = F(this), r = l.hasClass("dropdown-toggle"), a = (r ? l.closest(".dropdown") : l.closest(N.MENU)).data("this"), c = a.findLis(), d = !1, h = e.which === D && !r && !a.options.selectOnTab, p = P.test(e.which) || h, u = a.$menuInner[0].scrollTop, f = a.isVirtual(), m = !0 === f ? a.selectpicker.view.position0 : 0;
                if (!(i = a.$newElement.hasClass(q.SHOW)) && (p || 48 <= e.which && e.which <= 57 || 96 <= e.which && e.which <= 105 || 65 <= e.which && e.which <= 90) && a.$button.trigger("click.bs.dropdown.data-api"),
                ...
                p) {
                    ...
                    e.which === H ? (-1 !== t && t--,
                    t + m < 0 && (t += c.length),
                    a.selectpicker.view.canHighlight[t + m] || -1 === (t = a.selectpicker.view.canHighlight.slice(0, t + m).lastIndexOf(!0) - m) && (t = c.length - 1)) : (e.which === A || h) && (++t + m >= a.selectpicker.view.canHighlight.length && (t = 0),
                    ...
                    v = a.selectpicker.current.elements.length - 1) : d = (o = (n = a.selectpicker.current.data[v]).position - n.height) < u : (e.which === A || h) && (0 === t ? v = a.$menuInner[0].scrollTop = 0 : d = u < (o = (n = a.selectpicker.current.data[v]).position - a.sizeInfo.menuInnerHeight)),
                    ...
                    if (w.length) {
                        ...
                        0 < u - (n = a.selectpicker.current.data[g]).position ? (o = n.position - n.height,
                        d = !0) : (o = n.position - a.sizeInfo.menuInnerHeight,
                ...
                i && (e.which === T && !a.selectpicker.keydown.keyHistory || e.which === O || e.which === D && a.options.selectOnTab) && (e.which !== T && e.preventDefault(),
                a.options.liveSearch && e.which === T || (a.$menuInner.find(".active a").trigger("click", !0),
                l.focus(),
                a.options.liveSearch || (e.preventDefault(),
                F(document).data("spaceSelect", !0))))
            },
            mobile: function() {
